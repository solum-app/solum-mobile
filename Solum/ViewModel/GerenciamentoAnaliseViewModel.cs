    ...
    public class GerenciamentoAnaliseViewModel : BaseViewModel
    {
        ...
        private void GeneratePdf()
        {
            ...
            if (HasCalagemCalculation)
            {
                ...
                y = 130;
                g.DrawString(s, textFont, new PdfSolidBrush(_black), new PointF(25, y));
                y += 30;
            ...
            {
                y += 50;
                g.DrawString("Recomendação de Adubagem Corretiva", subHeadingFont, new PdfSolidBrush(_black), new PointF(25, y));
            ...
            {
                y += 50;
                g.DrawString("Recomendação de Adubagem de Semeadura", subHeadingFont, new PdfSolidBrush(_black), new PointF(25, y));
            ...
            {
                y += 50;
                g.DrawString("Recomendação da Adubagem de Cobertura", subHeadingFont, new PdfSolidBrush(_black), new PointF(25, y));
                y += 30;
                g.DrawString("Cultura", subHeadingFont, new PdfSolidBrush(_black), new PointF(25,y));
                g.DrawString("Expectativa", subHeadingFont, new PdfSolidBrush(_black), new PointF(125,y));
                g.DrawString("N", subHeadingFont, new PdfSolidBrush(_black), new PointF(225, y));
